...
if(localStorage.getItem("stockProductos")){
   ...
   stockProductos.push( new Producto(1, 1, "leche", 150, "leche.jpg"))
   stockProductos.push(new Producto(2, 1, "galletitas", 100, "galletas.jpg")) 
   stockProductos.push(new Producto(3, 1, "cerveza", 230, "cerveza.jpg")) 
   stockProductos.push(new Producto(4, 1, "manteca", 200, "manteca.jpg")) 
   stockProductos.push(new Producto(5, 1, "azucar", 100 , "azucar.jpg")) 
   stockProductos.push(new Producto(6, 1, "arroz", 150 , "arroz.jpg"))  
   stockProductos.push(new Producto(7, 1, "Papas lays ", 230, "papas-lays.jpg")) 
   stockProductos.push(new Producto(8, 1, "Doritos", 230, "doritos.jpg")) 
...
stockProductos.forEach((Producto) => {
    ...
    <div id= "${Producto.id}" class="card" style="width: 18rem; background-color:  rgb(185, 159, 210);">
     ...
     <div class="card-body">
       ...
       <a href="#" id="btnEliminar${Producto.id}" class="btn btn-outline-success " style= "background-color: purple;">Eliminar del carrito.</a>
    </div>`
